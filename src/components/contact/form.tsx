  ...
  return (
    <div className="ml-4 sm:ml-12 mt-16 sm:mt-32 bg-zinc-900 text-white p-6 sm:p-8">
      <div className="max-w-7xl mx-auto">
        <h1
          className={`${bebasNeue.className} text-4xl sm:text-6xl md:text-8xl font-bold mb-6 sm:mb-8`}
        >
          CONTACT
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          <div className="space-y-12">
            <p className="text-sm sm:text-lg font-medium sm:font-bold mt-6 sm:mt-12">
              Sagittis, faucibus nibh sed rhoncus lacus, amet, quis eget
              tristique
              <br />
            ...
            <div>
              <h2
                className={`${bebasNeue.className} text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6`}
              >
                SPEAK TO US
              </h2>
            ...
            <div>
              <h2
                className={`${bebasNeue.className} text-xl sm:text-2xl font-bold mb-4 sm:mb-6`}
              >
                FOLLOW US
              </h2>
