      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-12 md:gap-20">
          <div className="w-full md:w-1/2">
            <h3
              className={`${bebasNeue.className} text-3xl sm:text-4xl lg:text-6xl font-bold leading-tight text-center md:text-left mb-6`}
            >
              BEST IRISH PUB & BAR
            </h3>
            <h2
              className={`${bebasNeue.className} text-6xl font-bold uppercase mb-8 sm:mb-12 text-center md:text-left`}
            >
              IN FLORIDA
            </h2>
          </div>
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-[#DEE3E1] text-sm sm:text-base mb-8 text-center md:text-left">
              Commodo sit arcu curabitur egestas metus, dictum lectus<br></br>{" "}
              vulputate sed pharetra nisl, sed eget pellentesque magna<br></br>{" "}
              porttitor sed in maecenas maecenas rhoncus neque imperdiet
              <br></br> eget bibendum malesuada enim pharetra ultrices tempus
              <br></br> accumsan aenean nullam.
            </p>
